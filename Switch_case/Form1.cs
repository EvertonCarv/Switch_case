...
namespace Switch_case
{
    public partial class Form1 : Form
    {
        ...
        private void cboSemana_SelectedIndexChanged(object sender, EventArgs e)
        {
             ...
             * escolhida, aparecerá uma determinada mensagem, caso o usuário escolha Domingo, será uma msg,
             * caso seja segunda aparecerá outra msg e assim por diante, a cada case uma nova opção.
             * O break serve para sair de determinado comando, neste exemplo o (case) em execução*/
             { 
                case "Domingo":
            ...
            case "Sexta":
                ...
                break;
            case "Sabado":
                MessageBox.Show("Você escolheu Sabado que é o 7º dia da semana", "Mensagem",
                MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                break;
